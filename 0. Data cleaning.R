...
dim(data)
# We have 146734 rows and 605 variables. These
...
drops2 <- unique(c("ding_barely", "ding_minute", "ding_negligible", "ding_small", "ding_limited", "ding_almost", "ding_minor", "ding_little", "ding_invisible",
